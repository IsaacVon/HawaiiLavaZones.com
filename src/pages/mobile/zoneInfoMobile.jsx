...
class ZoneInfo extends Component {
  ...
  render() {
    return (
      <div className="mobileZoneInfoContainer">
        <img className="mobileMap" src={map} alt="map" />
        <div className="zoneNumberContainerMobile">
        ...
        <div className="moreInformationMobile">
