  ...
  render() {
    return (
      ...
      <ul class="collapsible">
        <li>
          <div class="collapsible-header #ff7043 deep-orange lighten-1">
            <i class="material-icons">local_fire_department</i>Zone 1
          </div>
          <div class="collapsible-body #ffccbc deep-orange lighten-5">
            <span>
        ...
        <li>
          <div class="collapsible-header #ffca28 amber lighten-">
            <i class="material-icons">local_fire_department</i>Zone 2
          </div>
          <div class="collapsible-body #ffecb3 amber lighten-5">
            <span>
        ...
        <li>
          <div class="collapsible-header #ffecb3 amber lighten-5">
            <i class="material-icons">filter_drama</i>Zone 3
          </div>
        ...
        <li>
          <div class="collapsible-header #fff8e1 #f1f8e9 light-green lighten-5">
            <i class="material-icons">filter_drama</i>Zone 4
          </div>
          <div class="collapsible-body">
            <span>
        ...
        <li>
          <div class="collapsible-header #f1f8e9 light-green lighten-4">
            <i class="material-icons">wb_sunny</i>Zone 5
          </div>
          <div class="collapsible-body #f1f8e9 light-green lighten-5">
            <span>
        ...
        <li>
          <div class="collapsible-header #f1f8e9 light-green lighten-3">
            <i class="material-icons">wb_sunny</i>Zone 6
          </div>
          <div class="collapsible-body #f1f8e9 light-green lighten-5">
            <span>
        ...
        <li>
          <div class="collapsible-header #f1f8e9 light-green lighten-2">
            <i class="material-icons">beach_access</i>Zone 7
          </div>
          <div class="collapsible-body #f1f8e9 light-green lighten-5">
            <span>
        ...
        <li>
          <div class="collapsible-header #f1f8e9 light-green lighten-2">
            <i class="material-icons">beach_access</i>Zone 8
          </div>
          <div class="collapsible-body #f1f8e9 light-green lighten-5">
            <span>
        ...
        <li>
          <div class="collapsible-header #f1f8e9 light-green lighten-2">
            <i class="material-icons">beach_access</i>Zone 9
          </div>
          <div class="collapsible-body #f1f8e9 light-green lighten-5">
            <span>
